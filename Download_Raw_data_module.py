...
class class_Download_raw_data_Operation():
    ...
    def download(self):
        ...
        url_list  = ["https://archives.nseindia.com/content/historical/DERIVATIVES/2021/MAY/fo{0}bhav.csv.zip".replace("{0}",Derivative_Date_Format),"https://archives.nseindia.com/products/content/sec_bhavdata_full_{0}.csv".replace("{0}",Cash_Date_Format)]
        print(url_list)
